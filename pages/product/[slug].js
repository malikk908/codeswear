    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-14 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-20 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/71A-czu4m1L._AC_UX679_.jpg" />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900">Rs. 1280</span>
              <button onClick={()=>{addToCart(slug, 1, 9999, 'Wear the Code', 'L', 'Red')}} className="flex ml-7 text-white bg-pink-500 border-0 py-2 px-1 text-sm md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
              <button className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-1 text-sm md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
            ...
            <div className="pin mt-5 flex space-x-2 text-sm">
              <input onChange={onChangePin} className='flex mx-1 px-3 py-2 border-gray-400 border-2 rounded-md' type="text" placeholder='Enter your Pincode' />
