        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              <button onClick={() => { addToCart(slug, 1, product.price, product.title, product.size, product.color) }} className="flex ml-7 text-white bg-pink-500 border-0 py-2 px-1 text-sm md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
              <button onClick={() => { buyNow(slug, 1, product.price, product.title, product.size, product.color) }} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-1 text-sm md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
...
export const getServerSideProps = async (context) => {
  ...
  for (let item of variants) {
    if (Object.keys(ColorSizeSlug).includes(item.color) && item.availableQty > 0) {
