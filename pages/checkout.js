...
const checkout = ({ cart, addToCart, removeFromCart, subTotal }) => {
  ...
  return (
    <div className='container px-6 sm:m-auto'>
      ...
      <section>
        <button onClick={handleCheckout} className="flex mr-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm" type="submit" role="link"><BsFillBagCheckFill className='m-1 mr-3' />
          Pay Rs.{subTotal}
        </button>
      </section>
